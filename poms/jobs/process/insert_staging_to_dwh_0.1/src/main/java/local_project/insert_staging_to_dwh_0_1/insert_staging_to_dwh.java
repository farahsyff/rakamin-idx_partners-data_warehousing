...
package local_project.insert_staging_to_dwh_0_1;
...
/**
 * Job: insert_staging_to_dwh Purpose: <br>
 * Description: <br>
 * 
 ...
 * @status
 */
public class insert_staging_to_dwh implements TalendJob {
	...
	private final String jobName = "insert_staging_to_dwh";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					insert_staging_to_dwh.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(insert_staging_to_dwh.this, new Object[] { e, currentComponent, globalMap });
							break;
						}
					}
	...
	public static class outputStruct implements routines.system.IPersistableRow<outputStruct> {
		final static byte[] commonByteArrayLock_LOCAL_PROJECT_insert_staging_to_dwh = new byte[0];
		static byte[] commonByteArray_LOCAL_PROJECT_insert_staging_to_dwh = new byte[0];
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_LOCAL_PROJECT_insert_staging_to_dwh.length) {
					if (length < 1024 && commonByteArray_LOCAL_PROJECT_insert_staging_to_dwh.length == 0) {
						commonByteArray_LOCAL_PROJECT_insert_staging_to_dwh = new byte[1024];
					} else {
						commonByteArray_LOCAL_PROJECT_insert_staging_to_dwh = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_LOCAL_PROJECT_insert_staging_to_dwh, 0, length);
				strReturn = new String(commonByteArray_LOCAL_PROJECT_insert_staging_to_dwh, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException {
			...
			if (length == -1) {
				...
				unmarshaller.readFully(commonByteArray_LOCAL_PROJECT_insert_staging_to_dwh, 0, length);
				strReturn = new String(commonByteArray_LOCAL_PROJECT_insert_staging_to_dwh, 0, length, utf8Charset);
			}
			return strReturn;
		}
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_LOCAL_PROJECT_insert_staging_to_dwh) {
	...
	public static class row1Struct implements routines.system.IPersistableRow<row1Struct> {
		...
		public void readData(ObjectInputStream dis) {
			...
			synchronized (commonByteArrayLock_LOCAL_PROJECT_insert_staging_to_dwh) {
				...
				try {
					...
					this.product_unit_price = dis.readInt();
		...
		public void writeData(ObjectOutputStream dos) {
			try {
				...
				dos.writeInt(this.product_unit_price);
	...
	public void tDBInput_1Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				String url_tDBOutput_1 = "jdbc:jtds:sqlserver://" + "FARAH";
				...
				dbUser_tDBOutput_1 = "farahsf";

				final String decryptedPassword_tDBOutput_1 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:jpKNYLyvbIsb6Xnf/qqcs5mFZSfCU4aZD6UCtojT7MAgn1J53JE=");
				...
				if (dbschema_tDBOutput_1 == null || dbschema_tDBOutput_1.trim().length() == 0) {
					tableName_tDBOutput_1 = "DimProduct";
				} else {
					tableName_tDBOutput_1 = dbschema_tDBOutput_1 + "].[" + "DimProduct";
				}
...
// ###############################
				...
				String dbUser_tDBInput_1 = "farahsf";

				final String decryptedPassword_tDBInput_1 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:1pL2JBnO/dCkAo8fdabDDHEEc0oZWodQzeTDWq1dr2fO6WL4rSQ=");

				String dbPwd_tDBInput_1 = decryptedPassword_tDBInput_1;

				String port_tDBInput_1 = "1433";
				String dbname_tDBInput_1 = "Staging";
				String url_tDBInput_1 = "jdbc:jtds:sqlserver://" + "FARAH";
				...
				try {
					...
					while (rs_tDBInput_1.next()) {
						...
						if (colQtyInRs_tDBInput_1 < 1) {
							...
							row1.product_id = rs_tDBInput_1.getInt(1);
						...
						if (colQtyInRs_tDBInput_1 < 3) {
							...
							if (tmpContent_tDBInput_1 != null) {
								if (talendToDBList_tDBInput_1.contains(
									...
									row1.product_category = FormatterUtils.formatUnwithE(tmpContent_tDBInput_1);
								} else {
									row1.product_category = tmpContent_tDBInput_1;
								}
							} else {
								row1.product_category = null;
							}
						...
						if (colQtyInRs_tDBInput_1 < 4) {
							row1.product_unit_price = 0;
						} else {

							row1.product_unit_price = rs_tDBInput_1.getInt(4);
							if (rs_tDBInput_1.wasNull()) {
								throw new RuntimeException("Null value in non-Nullable column");
							}
						}
...
// # Output table : 'output'
							output_tmp.ProductID = row1.product_id;
							output_tmp.ProductName = row1.product_name;
							output_tmp.ProductCategory = row1.product_category;
							output_tmp.ProductUnitPrice = row1.product_unit_price;
							output = output_tmp;
// ###############################
...
// Start of branch "output"
						if (output != null) {
							...
							pstmt_tDBOutput_1.setInt(1, output.ProductID);

							if (output.ProductName == null) {
								pstmt_tDBOutput_1.setNull(2, java.sql.Types.VARCHAR);
							} else {
								pstmt_tDBOutput_1.setString(2, output.ProductName);
							}

							if (output.ProductCategory == null) {
								pstmt_tDBOutput_1.setNull(3, java.sql.Types.VARCHAR);
							} else {
								pstmt_tDBOutput_1.setString(3, output.ProductCategory);
							}

							pstmt_tDBOutput_1.setInt(4, output.ProductUnitPrice);
	...
	public void tDBInput_2Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				String url_tDBOutput_2 = "jdbc:jtds:sqlserver://" + "FARAH";
				...
				dbUser_tDBOutput_2 = "farahsf";

				final String decryptedPassword_tDBOutput_2 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:BdPEWIzPPL6opoGbvklnMEBY/+upTMIBSc5rwpFWpzlNy+GfsSU=");
...
// ###############################
				...
				String dbUser_tDBInput_2 = "farahsf";

				final String decryptedPassword_tDBInput_2 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:JByJdHyfkMfDxi6SLofmXDENnCI4pTNv1RM7AoLI4rJeKUlqPB8=");

				String dbPwd_tDBInput_2 = decryptedPassword_tDBInput_2;

				String port_tDBInput_2 = "1433";
				String dbname_tDBInput_2 = "Staging";
				String url_tDBInput_2 = "jdbc:jtds:sqlserver://" + "FARAH";
				...
				try {
					...
					while (rs_tDBInput_2.next()) {
						...
						if (colQtyInRs_tDBInput_2 < 1) {
							...
							row2.customer_id = rs_tDBInput_2.getInt(1);
						...
						if (colQtyInRs_tDBInput_2 < 4) {
							...
							row2.age = rs_tDBInput_2.getInt(4);
							if (rs_tDBInput_2.wasNull()) {
								throw new RuntimeException("Null value in non-Nullable column");
							}
						}
						...
						if (colQtyInRs_tDBInput_2 < 7) {
							...
							if (tmpContent_tDBInput_2 != null) {
								if (talendToDBList_tDBInput_2.contains(
									...
									row2.noHP = FormatterUtils.formatUnwithE(tmpContent_tDBInput_2);
								} else {
									row2.noHP = tmpContent_tDBInput_2;
								}
							} else {
								row2.noHP = null;
							}
						...
						{ // start of Var scope
							...
							Var.var1 = StringHandling.UPCASE(row2.first_name + " " + row2.last_name);// ###############################
							// ###############################
							// # Output tables
...
// # Output table : 'output2'
							output2_tmp.CustomerID = row2.customer_id;
							output2_tmp.CustomerName = Var.var1;
							output2_tmp.Age = row2.age;
							output2_tmp.Gender = row2.gender;
							output2_tmp.City = row2.city;
							output2_tmp.NoHP = row2.noHP;
							output2 = output2_tmp;
// ###############################
...
// Start of branch "output2"
						if (output2 != null) {
							...
							pstmt_tDBOutput_2.setInt(1, output2.CustomerID);

							if (output2.CustomerName == null) {
								pstmt_tDBOutput_2.setNull(2, java.sql.Types.VARCHAR);
							} else {
								pstmt_tDBOutput_2.setString(2, output2.CustomerName);
							}

							pstmt_tDBOutput_2.setInt(3, output2.Age);

							if (output2.Gender == null) {
								pstmt_tDBOutput_2.setNull(4, java.sql.Types.VARCHAR);
							} else {
								pstmt_tDBOutput_2.setString(4, output2.Gender);
							}

							if (output2.City == null) {
								pstmt_tDBOutput_2.setNull(5, java.sql.Types.VARCHAR);
							} else {
								pstmt_tDBOutput_2.setString(5, output2.City);
							}

							if (output2.NoHP == null) {
								pstmt_tDBOutput_2.setNull(6, java.sql.Types.VARCHAR);
							} else {
								pstmt_tDBOutput_2.setString(6, output2.NoHP);
							}
...
// ###############################      
	...
	public static class copyOfoutput2Struct implements routines.system.IPersistableRow<copyOfoutput2Struct> {
		final static byte[] commonByteArrayLock_LOCAL_PROJECT_insert_staging_to_dwh = new byte[0];
		static byte[] commonByteArray_LOCAL_PROJECT_insert_staging_to_dwh = new byte[0];
		protected static final int DEFAULT_HASHCODE = 1;
		protected static final int PRIME = 31;
		...
		public boolean equals(Object obj) {
			...
			if (getClass() != obj.getClass())
				return false;
			final copyOfoutput2Struct other = (copyOfoutput2Struct) obj;
		...
		public void copyDataTo(copyOfoutput2Struct other) {
		...
		public void copyKeysDataTo(copyOfoutput2Struct other) {
		 ...
		 * Compare keys
		 */
		public int compareTo(copyOfoutput2Struct other) {
	...
	public void tDBInput_3Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				copyOfoutput2Struct copyOfoutput2 = new copyOfoutput2Struct();
				...
				if (execStat) {
					runStat.updateStatOnConnection(resourceMap, iterateId, 0, 0, "copyOfoutput2");
				}
				...
				String url_tDBOutput_3 = "jdbc:jtds:sqlserver://" + "FARAH";
				...
				dbUser_tDBOutput_3 = "farahsf";

				final String decryptedPassword_tDBOutput_3 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:sBXCvyzKJNllEqMKXvK1XGDWFfEp/p1jxk80IXUMcocUSTGr42U=");
...
// ###############################
// # Outputs initialization
				copyOfoutput2Struct copyOfoutput2_tmp = new copyOfoutput2Struct();
// ###############################
...
// # Output table : 'copyOfoutput2'
							copyOfoutput2_tmp.StatusID = row3.status_id;
							copyOfoutput2_tmp.StatusOrder = row3.status_order;
							copyOfoutput2_tmp.StatusOrderDesc = row3.status_order_desc;
							copyOfoutput2 = copyOfoutput2_tmp;
// ###############################
						 ...
						 */
// Start of branch "copyOfoutput2"
						if (copyOfoutput2 != null) {
							...
							pstmt_tDBOutput_3.setInt(1, copyOfoutput2.StatusID);

							if (copyOfoutput2.StatusOrder == null) {
								pstmt_tDBOutput_3.setNull(2, java.sql.Types.VARCHAR);
							} else {
								pstmt_tDBOutput_3.setString(2, copyOfoutput2.StatusOrder);
							}

							if (copyOfoutput2.StatusOrderDesc == null) {
								pstmt_tDBOutput_3.setNull(3, java.sql.Types.VARCHAR);
							} else {
								pstmt_tDBOutput_3.setString(3, copyOfoutput2.StatusOrderDesc);
							}
...
// ###############################      
				...
				if (execStat) {
					runStat.updateStat(resourceMap, iterateId, 2, 0, "copyOfoutput2");
				}
	...
	public static class copyOfcopyOfoutput2Struct
			implements routines.system.IPersistableRow<copyOfcopyOfoutput2Struct> {
		final static byte[] commonByteArrayLock_LOCAL_PROJECT_insert_staging_to_dwh = new byte[0];
		static byte[] commonByteArray_LOCAL_PROJECT_insert_staging_to_dwh = new byte[0];
		protected static final int DEFAULT_HASHCODE = 1;
		protected static final int PRIME = 31;
		...
		public boolean equals(Object obj) {
			...
			if (getClass() != obj.getClass())
				return false;
			final copyOfcopyOfoutput2Struct other = (copyOfcopyOfoutput2Struct) obj;
		...
		public void copyDataTo(copyOfcopyOfoutput2Struct other) {
		...
		public void copyKeysDataTo(copyOfcopyOfoutput2Struct other) {
		 ...
		 * Compare keys
		 */
		public int compareTo(copyOfcopyOfoutput2Struct other) {
	...
	public void tDBInput_4Process(final java.util.Map<String, Object> globalMap) throws TalendException {
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				copyOfcopyOfoutput2Struct copyOfcopyOfoutput2 = new copyOfcopyOfoutput2Struct();
				...
				if (execStat) {
					runStat.updateStatOnConnection(resourceMap, iterateId, 0, 0, "copyOfcopyOfoutput2");
				}
				...
				String url_tDBOutput_4 = "jdbc:jtds:sqlserver://" + "FARAH";
				...
				dbUser_tDBOutput_4 = "farahsf";

				final String decryptedPassword_tDBOutput_4 = routines.system.PasswordEncryptUtil.decryptPassword(
						"enc:routine.encryption.key.v1:S+DIp9UP9IGXRtSEnxkF23a63i0JZHyW0S2qUjWl2wqWmfpQwho=");
...
// ###############################
// # Outputs initialization
				copyOfcopyOfoutput2Struct copyOfcopyOfoutput2_tmp = new copyOfcopyOfoutput2Struct();
// ###############################
				...
				try {
					...
					while (rs_tDBInput_4.next()) {
						...
						{ // start of Var scope
							...
							copyOfcopyOfoutput2 = null;

// # Output table : 'copyOfcopyOfoutput2'
							copyOfcopyOfoutput2_tmp.OrderID = row4.order_id;
							copyOfcopyOfoutput2_tmp.CustomerID = row4.customer_id;
							copyOfcopyOfoutput2_tmp.ProductID = row4.product_id;
							copyOfcopyOfoutput2_tmp.Quantity = row4.quantity;
							copyOfcopyOfoutput2_tmp.Amount = row4.amount;
							copyOfcopyOfoutput2_tmp.StatusID = row4.status_id;
							copyOfcopyOfoutput2_tmp.OrderDate = row4.order_date;
							copyOfcopyOfoutput2 = copyOfcopyOfoutput2_tmp;
// ###############################
						 ...
						 */
// Start of branch "copyOfcopyOfoutput2"
						if (copyOfcopyOfoutput2 != null) {
							...
							pstmt_tDBOutput_4.setInt(1, copyOfcopyOfoutput2.OrderID);

							pstmt_tDBOutput_4.setInt(2, copyOfcopyOfoutput2.CustomerID);

							pstmt_tDBOutput_4.setInt(3, copyOfcopyOfoutput2.ProductID);

							pstmt_tDBOutput_4.setInt(4, copyOfcopyOfoutput2.Quantity);

							pstmt_tDBOutput_4.setInt(5, copyOfcopyOfoutput2.Amount);

							pstmt_tDBOutput_4.setInt(6, copyOfcopyOfoutput2.StatusID);

							if (copyOfcopyOfoutput2.OrderDate != null) {
								pstmt_tDBOutput_4.setTimestamp(7,
										new java.sql.Timestamp(copyOfcopyOfoutput2.OrderDate.getTime()));
							} else {
						...
						} // End of branch "copyOfcopyOfoutput2"
...
// ###############################      
				...
				if (execStat) {
					runStat.updateStat(resourceMap, iterateId, 2, 0, "copyOfcopyOfoutput2");
				}
	...
	public static void main(String[] args) {
		final insert_staging_to_dwh insert_staging_to_dwhClass = new insert_staging_to_dwh();

		int exitCode = insert_staging_to_dwhClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = insert_staging_to_dwh.class.getClassLoader().getResourceAsStream(
					"local_project/insert_staging_to_dwh_0_1/contexts/" + contextStr + ".properties");
			if (inContext == null) {
				inContext = insert_staging_to_dwh.class.getClassLoader()
		...
		if (false) {
			System.out.println(
					(endUsedMemory - startUsedMemory) + " bytes memory increase when running : insert_staging_to_dwh");
		}
...
/************************************************************************************************
 * 181556 characters generated by Talend Open Studio for Data Integration on the
 * January 21, 2024 at 1:56:26 PM WIB
 ************************************************************************************************/